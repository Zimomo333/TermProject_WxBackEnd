...
public class User {
    ...
    public User(String id, String open_id, String password, String name, int sex, String identity_card, String photo, String house_no, int health_status, int access_times, Boolean is_locked) {
        this.id = id;
